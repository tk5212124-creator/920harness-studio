...
const NODE_CASES = [
  ...
  ['onTruncate / onBadOutput / onError', { id: 'X', type: 'llm', mock: { text: 'a' }, onTruncate: 'retry', onBadOutput: 'retry', onError: 'value', onErrorValue: 1 },
    ['onTruncate', 'onBadOutput', '__onError', 'onErrorValue']],
